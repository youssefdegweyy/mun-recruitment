                            ...
                            <div class="card card-custom">
                                <div class="card-header py-3">
                                    <div class="card-title">
                                        ...
                                        <h3 class="card-label">Add Interview Time</h3>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="card card-custom">
                                        <div class="card card-custom">
                                            ...
                                            <form class="form" method="POST"
                                                  action="{{ route('interviews-time.store') }}">
                                                @csrf
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="date" name="date"
                                                               value="{{ old('date') }}"/>
                                                        @if ($errors->has('date'))
                                                            <span style="color:red"><b> {{ $errors->first('date') }}</b></span>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="time" type="text"
                                                               placeholder="Time, example: 2:30"
                                                               value="{{ old('time') }}"
                                                               autocomplete="off"/>
                                                        @if ($errors->has('time'))
                                                            <span style="color:red"><b> {{ $errors->first('time') }}</b></span>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if ($errors->has('type'))
                                                            <span
                                                                style="color:red"><b> {{ $errors->first('type') }}</b></span>
                                                        @endif
                                                    </div>
