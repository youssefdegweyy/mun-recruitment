                            ...
                            <div class="card card-custom">
                                <div class="card-header py-3">
                                    <div class="card-title">
                                        ...
                                        <h3 class="card-label">Edit Interview - {{ $interview->name }}</h3>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="card card-custom">
                                        <div class="card card-custom">
                                            ...
                                            <form class="form" method="POST"
                                                  action="{{ route('answers.update', $interview) }}"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="grade" required>
                                                            ...
                                                            <option
                                                                value="A" {{ $interview->grade == "A" ? 'selected' : '' }}>
                                                                A
                                                            </option>
                                                            <option
                                                                value="B" {{ $interview->grade == "B" ? 'selected' : '' }}>
                                                                B
                                                            </option>
                                                            <option
                                                                value="C" {{ $interview->grade == "C" ? 'selected' : '' }}>
                                                                C
                                                            </option>
                                                            <option
                                                                value="D" {{ $interview->grade == "D" ? 'selected' : '' }}>
                                                                D
                                                            </option>
                                                        </select>
                                                        @if ($errors->has('grade'))
                                                ...
                                                <div class="card-footer">
                                                    ...
                                                    <a href="{{ url('/answers/'. $interview->id) }}"
