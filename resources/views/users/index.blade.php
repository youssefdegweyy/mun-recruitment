                                    ...
                                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td>{{ $user->email }}</td>
                                                <td>
                                                    @if($user->role == \App\Models\User::BOOTH)
                                                        Booth User
                                                    @elseif($user->role == \App\Models\User::INTERVIEWS)
                                                        Interviews User
                                                    @elseif($user->role == \App\Models\User::DIRECTOR_GENERAL)
                                                        Director General
                                                    @else
                                                        USG for AC
                                                    @endif
                                                </td>
                                                <td>{{ $user->category ? $user->category->name : 'Admin' }}</td>
                                                <td>
